    ...
    return (
        ...
        <div className={`review-content ${reviewShow ? "review-content-show" : "description-show"}`}>
          ...
          <div className='description'> 
           <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati alias quasi fuga placeat doloribus repellendus a dolores cum illum eum magni inventore quaerat odit voluptate accusantium non numquam quisquam ducimus, assumenda quo excepturi! Facere labore laborum minima, modi blanditiis, vitae sit molestias veniam ipsa dignissimos eligendi explicabo doloribus, placeat itaque.</p>
           <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Obcaecati alias quasi fuga placeat doloribus repellendus a dolores cum illum eum magni inventore quaerat odit voluptate accusantium non numquam quisquam ducimus, assumenda quo excepturi! Facere labore laborum minima, modi blanditiis, vitae sit molestias veniam ipsa dignissimos eligendi explicabo doloribus, placeat itaque.</p>
           ...
           <div className='post-item'>
            ...
            <div className='post-content'>
             <ul className='lab-ul'>
               <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, delectus!</li>
               <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, delectus!</li>
               <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, delectus!</li>
               <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, delectus!</li>
               <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Iste, delectus!</li>
